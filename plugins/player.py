...
async def not_chat(_, m: Message):
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN MUSIC BOT", url="https://github.com/xhrvan/EvilMusic"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/b59e00c649f75fffbcd5d.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source Code](https://github.com/xhrvan/EvilMusic) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
